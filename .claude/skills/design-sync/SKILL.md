...
4. Regenerate PDF: `cd /Users/ramanambore/projects/ramboq && python3 docs/generate_pdf.py`
5. Stage and commit both: `git add docs/DESIGN_GUIDE.md docs/DESIGN_GUIDE.pdf && git commit -m "docs(design): sync DESIGN_GUIDE with recent changes $(date +%Y-%m-%d)"`

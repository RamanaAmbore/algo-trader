  ...
  const sections = [
    ...
    },
    {
      ...
      bullets: [
        ...
        'Daily background task at 02:30 IST recomputes every row older than 7 days, paces 1s/row to stay under Kite\'s 3 req/sec historical budget. Failed regressions stamp regression_at so broken pairs don\'t retry every day',

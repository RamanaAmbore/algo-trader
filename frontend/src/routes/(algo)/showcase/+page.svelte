...
<div class="show">
  ...
  <header class="show-hero">
    ...
    <p class="show-tag">A production quant trading platform — built end-to-end by one engineer for the RamboQuant LLP partnership. You're looking at the live system, accounts masked.</p>

...
<svelte:head>
  <title>Daily Market Report | RamboQuant Analytics</title>
  <meta name="description" content="AI-generated daily reports on Indian equity markets, options activity, and macroeconomic events." />

  <!-- Open Graph -->
  <meta property="og:title" content="Daily Market Report | RamboQuant Analytics" />
...
<style>
  ...
  /* Active state mirrors the AlgoTabs canonical 10% bg tint that
     ...
     public page shares one active-state decoration: champagne
     underline + 10% champagne background. Operator: "have nav funds
     background decoration to other tabs in public pages." */
  .market-tab-active {
    color: #1a2744;
    font-weight: 700;
